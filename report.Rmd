...
Nel seguente elaborato si intende prevedere l'abbandono scolastico utilizzando caratteristiche accademiche, demografiche e comportamentali degli studenti. L'analisi è stata condotta tramite il software R, utilizzando il dataset "Student Dropout Prediction Dataset" presente su Kaggle, costituito da una simulazione relativa a 10000 studenti. I dati, infatti, riproducono fedelmente le distribuzioni reali degli studenti, mantenendo asimmetrie, valori mancanti in alcune osservazioni e correlazioni tra esse. L’obiettivo di questo progetto è individuare il miglior modello che, date alcune caratteristiche dello studente, sia in grado di prevedere se esso completerà o meno gli studi. La nostra analisi ha lo scopo di prevedere se uno studente abbandoni il ciclo di studi prima
...
Dai dati originali, vedo che molti studenti completano i loro studi, mentre chi abbandona è in numero minore. Siamo quindi in presenza di dati sbilanciati.
